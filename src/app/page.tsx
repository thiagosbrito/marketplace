...
import { auth as nextauth } from "./api/auth/[...nextauth]/route";
import FeatureProduct from "@/components/website/FeaturedProduct";
  ...
  return (
    <>
        ...
        <div className="flex-grow flex-1">
          ...
          <section id="featured-products" className="bg-white container my-6">
            <h2 className="text-3xl font-bold text-center text-gray-900 my-6">Featured Products</h2>
