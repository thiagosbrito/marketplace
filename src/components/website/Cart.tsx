...
import EmptyCartAnimation from '../../../public/lotties/empty_cart.json';
  ...
  return (
    <Sheet>
      ...
      <SheetContent className="flex w-full flex-col pr-0 sm-max-w-lg">
            ...
            <div className="space-y-4 pr-6">
              ...
              <div className="space-y-1.5 text-sm">
                ...
                <div className="flex ">
                  ...
                  <span className="text-sm">{formatPrice(1)}</span>
                </div>
              </div>
              <SheetFooter>
        ...
        ) : (<div className="flex h-full flex-col items-center text-center justify-center space-y-1">
